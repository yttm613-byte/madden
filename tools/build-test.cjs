...
const TEST = `  window.__gb={get G(){return G;},get ready(){return playersReady;},get pool(){return pPool;},get scene(){return scene;},get camera(){return camera;},get ballMesh(){return ballMesh;},get renderer(){return renderer;},startFG,startKick,fgLock,choosePlay,snap,action,setupPlay,juke,recordFrame,startReplay,stopReplay,cycleQuality,toggleFullscreen,startConversion,tryFumble,startPossession,update,keys,render3D,throwBall,swatBall,stiffArm,carrierDive,releaseThrow,pollPad,padBar,togglePause,get PAD(){return PAD;},get q(){return qKey;}};\n`;
...
const SIM = `  window.__gbNoDraw=true; try{ window.AudioContext=undefined; window.webkitAudioContext=undefined; Object.defineProperty(window,'speechSynthesis',{value:undefined,configurable:true}); }catch(e){}\n  window.__sim={ get G(){return G;}, update, keys, choosePlay, action, snap, chooseDef,\n    startFG, startKick, startKickoff, startConversion, fgLock, juke, spin, setupPlay, startPossession, endPlay, startPunt, callTimeout, throwBall, swatBall, stiffArm, carrierDive, releaseThrow, get ready(){return playersReady;}, get pool(){return pPool;} };\n`;
