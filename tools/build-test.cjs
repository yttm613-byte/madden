...
const TEST = `  window.__gb={get G(){return G;},get ready(){return playersReady;},get pool(){return pPool;},get scene(){return scene;},get camera(){return camera;},get ballMesh(){return ballMesh;},get renderer(){return renderer;},startFG,startKick,fgLock,choosePlay,snap,action,setupPlay,juke,recordFrame,startReplay,stopReplay,cycleQuality,toggleFullscreen,startConversion,tryFumble,startPossession,update,keys,render3D,gameOver,showTeam,myTeam,throwBall,swatBall,stiffArm,carrierDive,releaseThrow,pollPad,padBar,togglePause,get PAD(){return PAD;},get q(){return qKey;}};\n`;
