...
const SIM = `  window.__gbNoDraw=true; window.__gbRatings=window.__gbRatings||'neutral'; window.__gbWeather=window.__gbWeather||'clear'; window.__gbNoIntro=true; window.__gbNoTips=true; window.__gbNoLod=true; try{ window.AudioContext=undefined; window.webkitAudioContext=undefined; Object.defineProperty(window,'speechSynthesis',{value:undefined,configurable:true}); }catch(e){}\n  window.__sim={ get G(){return G;}, update, keys, choosePlay, action, snap, chooseDef,\n    startFG, startKick, startKickoff, startConversion, fgLock, juke, spin, setupPlay, startPossession, endPlay, startPunt, callTimeout, throwBall, swatBall, stiffArm, carrierDive, releaseThrow, makeRoster, rateUp, ev:(s)=>eval(s), get ready(){return playersReady;}, get pool(){return pPool;} };\n`;
